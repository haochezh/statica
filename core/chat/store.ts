...
const AGENT_STORAGE_KEY = "statica:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "statica:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "statica:chat:drafts";
/** Placeholder sessionId for a chat that hasn't been created yet. */
export const DRAFT_NEW_SESSION = "__new__";
const CHAT_WIDTH_KEY = "statica:chat:width";
const CHAT_HEIGHT_KEY = "statica:chat:height";
const CHAT_EXPANDED_KEY = "statica:chat:expanded";
