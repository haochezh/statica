 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "statica-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "statica-static.copilothub.ai")
 */
