...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@statica/ui/components/ui/collapsible";
import { Loader2, ChevronRight, ChevronDown, Brain, AlertCircle } from "lucide-react";
import { useScrollFade } from "@statica/ui/hooks/use-scroll-fade";
import { useAutoScroll } from "@statica/ui/hooks/use-auto-scroll";
import { taskMessagesOptions } from "@statica/core/chat/queries";
import { Markdown } from "@statica/views/common/markdown";
import type { ChatMessage, TaskMessagePayload } from "@statica/core/types";
import type { ChatTimelineItem } from "@statica/core/chat";
