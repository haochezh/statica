...
import { agentListOptions, memberListOptions } from "@statica/core/workspace/queries";
import { canAssignAgent } from "@statica/views/issues/components";
...
import {
  ...
  chatKeys,
} from "@statica/core/chat/queries";
import { useCreateChatSession, useMarkChatSessionRead } from "@statica/core/chat/mutations";
...
import type { Agent, ChatMessage, ChatSession } from "@statica/core/types";
    ...
    <div className="flex flex-1 flex-col items-center justify-center gap-5 px-6 py-8">
      <div className="text-center space-y-1">
        <h3 className="text-base font-semibold">
          {agentName ? `Hi, I'm ${agentName}` : "Welcome to Statica"}
        </h3>
