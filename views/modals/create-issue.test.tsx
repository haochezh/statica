...
vi.mock("@statica/core/issues/stores/draft-store", () => ({
...
vi.mock("@statica/core/issues/mutations", () => ({
...
vi.mock("@statica/ui/components/ui/dialog", () => ({
...
vi.mock("@statica/ui/components/ui/tooltip", () => ({
  Tooltip: ({ children }: { children: React.ReactNode }) => <>{children}</>,
  TooltipTrigger: ({ render }: { render: React.ReactNode }) => <>{render}</>,
  TooltipContent: ({ children }: { children: React.ReactNode }) => <>{children}</>,
}));

vi.mock("@statica/ui/components/ui/button", () => ({
  Button: ({
    children,
    disabled,
    onClick,
...
vi.mock("@statica/ui/components/common/file-upload-button", () => ({
