...
import type { Comment, TimelineEntry, Reaction } from "@statica/core/types";
import type {
...
import { issueTimelineOptions, issueKeys } from "@statica/core/issues/queries";
import {
  useCreateComment,
  useUpdateComment,
  useDeleteComment,
...
} from "@statica/core/issues/mutations";
