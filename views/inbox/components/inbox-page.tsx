...
} from "@statica/core/inbox/queries";
import {
  useMarkInboxRead,
  useArchiveInbox,
  useMarkAllInboxRead,
...
} from "@statica/core/inbox/mutations";
...
import type { InboxItem } from "@statica/core/types";
...
export function InboxPage() {
  ...
  const detailContent = selected?.issue_id ? (
    <IssueDetail
      ...
      layoutId="statica_inbox_issue_detail_layout"
