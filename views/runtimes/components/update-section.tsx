...
import type { RuntimeUpdateStatus } from "@statica/core/types";

const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/statica-ai/statica/releases/latest";
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {isManaged ? (
          <span
            ...
            title="The CLI binary is managed by Statica Desktop — update Desktop to upgrade the CLI."
          >
            Managed by Desktop
          </span>
        ) : (
